...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RVS Agri — Tradition Agriculture from the Cauvery Delta" },
      ...
      { name: "author", content: "RVS Agri" },
      { property: "og:title", content: "RVS Agri — Tradition Agriculture from the Cauvery Delta" },
